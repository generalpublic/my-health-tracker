...
def upsert_sleep(conn, date_str, data):
    ...
    """, (
        ...
        _day_from_date(date_str),
        _to_num(data.get("sleep_score")),
        None,  # sleep_analysis_score — computed in Sheets, not available in data dict
        _to_num(data.get("sleep_duration")),
        None,  # sleep_analysis text — generated by Sheets write function
        None,  # notes — manual entry
        None,  # cognition — manual entry
        None,  # cognition_notes — manual entry
