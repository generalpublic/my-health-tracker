...
ALLOWLIST = {
    ...
    "js/today.js:302",   # expect effects (escapeHtml on all text)
    "js/today.js:305",   # flags list (escapeHtml on all text)
    "js/today.js:310",   # do items list (escapeHtml on all text)
    "js/today.js:346",   # sleep stages bar (computed percentages, CSS vars)
    "js/today.js:365",   # sleep stages detail (computed values, predefined labels)
    "js/today.js:396",   # sleep context stats (escapeHtml on label and value)
    "js/today.js:412",   # body battery gauge SVG (computed numeric values)
    "js/today.js:452",   # habits row (predefined icons/labels, computed state)
    "js/today.js:478",   # activity sessions (escapeHtml on activity_name)
    "js/today.js:518",   # insights list (escapeHtml on all text)
    "js/today.js:525",   # recommendations section (escapeHtml on all text)
    "js/today.js:532",   # recommendations clear (empty string)
    "js/today.js:558",   # insertAdjacentHTML — preliminary badge (static markup)
